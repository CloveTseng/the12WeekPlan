...
<template>
  <div class="bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-700">
    ...
    <div class="mb-6">
      ...
      <div
        v-if="currentMonthPlans.length > 0"
        class="mt-4 bg-morandi-blue/10 rounded-lg p-3 border border-morandi-blue/20"
      >
        <div class="text-xs font-semibold text-morandi-blue mb-2 uppercase tracking-wide">
          Month {{ currentMonth }} Plans (w{{ (currentMonth - 1) * 4 + 1 }} ~ w{{
            currentMonth * 4
          }})
        </div>
        <div class="space-y-1">
      ...
      <div class="space-y-2 mb-4">
        ...
        >
          <button
            ...
            :class="
              action.is_completed
                ? 'bg-morandi-green border-morandi-green text-gray-900'
                : 'hover:border-morandi-blue'
            "
          >
        ...
        <div
          v-if="projectActions.length === 0 && !isLoading"
