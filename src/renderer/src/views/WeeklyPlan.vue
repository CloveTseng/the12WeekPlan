...
<template>
  <div class="h-full flex flex-col p-8 overflow-hidden">
    ...
    <div class="flex justify-between items-center mb-8">
      <div>
        ...
        <p class="text-gray-400">
          Q{{ store.currentQuarter }} {{ store.currentYear }} - Month {{ currentMonth }} - Week
          {{ store.currentWeek }}
        </p>
      </div>
      <button
    ...
    <!-- Week Selector -->
    <div
      class="flex space-x-2 mb-8 overflow-x-auto pb-2 scrollbar-thin scrollbar-thumb-gray-700 scrollbar-track-transparent"
    >
      <button
        v-for="week in weeks"
        :key="week"
